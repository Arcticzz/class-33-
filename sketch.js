...
function setup() {
  ...
  button1.position(330,50);
  button1.size(50,50);
  button1.mouseClicked(drop2);


  rope3 = new Rope(10,{x:57,y:40});
  rope = new Rope(7,{x:245,y:30});
  rope2 = new Rope(8,{x:350,y:55});
  ground = new Ground(200,canH,600,20);

  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(Math.round(random(100, 400)),canH-80,100,100);
  bunny.scale = 0.2;
